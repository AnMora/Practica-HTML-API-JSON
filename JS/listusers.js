...
function Users(objUsuario){
    ...
    objUsuario.map(function(objUsuario){
        ...
        // var strWebsite = '<div class="mb-2 pb-2 col-md-12 text-white flex-column align-items-start">' + '<div class="d-flex w-100 justify-content-between">' + '<small><a class="btn btn-primary mb-2" href="' + objUsuario.website + '">' + objUsuario.website + '</a></small>';
        ...
        // var strPhone = '<p>' + 'Telfono: ' + objUsuario.phone + '</p>' + '</div>';
            ...
            $('#Users').append(strUsername +  strEmail);
